...
export default function TimetableScreen({route, navigation}) {
  ...
  const timetable = [{
    ...
    Times: [
      ...
      '11:00', '12:30', '13:00', '13:30', '14:00', '14:30', '15:00', '15:30', '16:00', '16:30',
      '17:00', '17:30', '18:00', '18:30', '19:00', '19:30', '20:00', '21:30', '22:00', '22:30', '23:00', '23:30']},
  {
    Semana: 'Terça-Feira',
    Times: [
      '06:00', '06:30', '07:00', '07:30', '08:00', '08:30', '09:00', '09:30', '10:00', '10:30',
  ...
  function onCheckHorario(semana, tempo) {
    ...
    if (check > -1) {
      ...
      if (check2) {
        ...
        timetableselected[check].Times.splice(index, 1);
        if (timetableselected[check].Times.length == 0) {
          timetableselected.splice(check, 1);
        }
